...
import samaryanin.avitofork.shared.ui.theme.lightBlueColor
            ...
            Box(
                ...
                FlowRow(modifier = Modifier.wrapContentSize(), horizontalArrangement = Arrangement.End) {
                    Text(
                        ...
                        fontSize = LocalDimensions.Chat.FontSize.fontSizeMessage1,
                    ...
                    Row(modifier = Modifier.align(Alignment.Bottom).offset(0.dp, (4).dp)) {
                        ...
                        Text(
                            ...
                            fontSize = LocalDimensions.Chat.FontSize.fontSizeMessageTimestamp,
                            color = Color.Gray,
                        )
                        Space(4.dp)
